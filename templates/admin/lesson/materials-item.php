...
foreach ( $materials as $key => $material ) :
	...
	<div class="stlms-materials-list-item">
		<ul>
			...
			<li class="assignment-type"><?php echo 'upload' === $method ? esc_html__( 'Upload', 'skilltriks-lms' ) : esc_html__( 'External', 'skilltriks-lms' ); ?></li>
			<li>
		...
		<div class="stlms-materials-item hidden">
			<div class="stlms-media-choose">
				...
				<input type="text" class="material-file-title" value="<?php echo isset( $material['title'] ) ? esc_attr( $material['title'] ) : ''; ?>" name="<?php echo esc_attr( $this->meta_key_prefix ); ?>[material][<?php echo (int) $key; ?>][title]" placeholder="<?php esc_attr_e( 'Enter File Title', 'skilltriks-lms' ); ?>">
			</div>
			<div class="stlms-media-choose material-type">
				...
				<select name="<?php echo esc_attr( $this->meta_key_prefix ); ?>[material][<?php echo (int) $key; ?>][method]">
					<option value="upload"<?php selected( 'upload', $method ); ?>><?php esc_html_e( 'Upload', 'skilltriks-lms' ); ?></option>
					<option value="external"<?php selected( 'external', $method ); ?>><?php esc_html_e( 'External', 'skilltriks-lms' ); ?></option>
				</select>
			</div>
			<div class="stlms-media-choose<?php echo esc_attr( 'upload' !== $method ? ' hidden' : '' ); ?>" data-media_type="choose_file">
				...
				<?php if ( $media_id ) : ?>
					...
					<a href="javascript:;" class="stlms-open-media button" data-library_type="application/pdf, text/plain" data-ext="<?php echo esc_attr( apply_filters( 'stlms_lesson_allowed_material_types', 'pdf,txt' ) ); ?>"><?php esc_html_e( 'Change File', 'skilltriks-lms' ); ?></a>
			...
			<div class="stlms-media-choose<?php echo esc_attr( 'external' !== $method ? ' hidden' : '' ); ?>" data-media_type="file_url">
				...
				<input type="text" value="<?php echo isset( $material['external_url'] ) ? esc_url( $material['external_url'] ) : ''; ?>" name="<?php echo esc_attr( $this->meta_key_prefix ); ?>[material][<?php echo (int) $key; ?>][external_url]" placeholder="<?php esc_attr_e( 'Enter File URL', 'skilltriks-lms' ); ?>">
			</div>
