...
$meta_key_prefix = \ST\Lms\META_KEY_QUESTION_PREFIX;
?>
<script type="text/template" id="show_answer">
	<?php wp_nonce_field( 'inlineeditnonce', '_inline_edit', false ); ?>
	<input type="hidden" name="_status" value="">
	<input type="hidden" name="screen" value="edit-<?php echo esc_attr( \ST\Lms\STLMS_QUESTION_CPT ); ?>">
									...
									<ul class="stlms-options-table__list">
										<li>
											<div class="stlms-options-value">
												...
												<div class="stlms-options-no"><?php echo esc_html( sprintf( '%s.', isset( $alphabets[ $key ] ) ? $alphabets[ $key ] : '' ) ); ?></div>
									...
									<ul class="stlms-options-table__list">
										<li>
											<div class="stlms-options-value">
												...
												<input type="text" class="stlms-option-value-input" value="<?php echo esc_attr( $answer ); ?>" name="<?php echo esc_attr( $meta_key_prefix ); ?>[true_or_false][]" readonly>
											</div>
										</li>
										<li class="stlms-option-check-td">
	...
	<ul class="stlms-options-table__list">
		<li>
			<div class="stlms-options-value">
				...
				<input type="text" value="{{VALUE}}" class="stlms-option-value-input" name="<?php echo esc_attr( $meta_key_prefix ); ?>[true_or_false][]" readonly>
			</div>
		</li>
		<li class="stlms-option-check-td">
	...
	<ul class="stlms-options-table__list">
		<li>
			<div class="stlms-options-value">
				...
				<div class="stlms-options-no">{{OPTION_NO}}.</div>
