...
<div class="stlms-qus-setting-wrap">
	...
	<div class="stlms-qus-setting-header">
		...
		<div>
			<label><input type="checkbox" name="<?php echo esc_attr( $this->meta_key_prefix ); ?>[settings][status]" value="1"<?php checked( $status, 1 ); ?>><?php esc_html_e( 'Hide Question? ', 'skilltriks-lms' ); ?></label>
		</div>
	</div>
