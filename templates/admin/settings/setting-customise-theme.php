...
<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post">
	...
	<div class="stlms-tab-title-wrap">
		...
		<div class="btn-wrap">
			<button type="submit" name="reset" class="button button-outline"><?php esc_html_e( 'Reset', 'skilltriks-lms' ); ?></button>
			<input type="submit" class="button button-primary" name="submit" value="<?php esc_html_e( 'Save & Update', 'skilltriks-lms' ); ?>" />
		</div>
	...
	<div class="stlms-customization-wrap">
		<div class="stlms-customization-title">
			<?php esc_html_e( 'Choose Colors', 'skilltriks-lms' ); ?>
		</div>
	...
	<div class="stlms-customization-wrap">
		<div class="stlms-customization-title">
			<?php esc_html_e( 'Choose Fonts', 'skilltriks-lms' ); ?>
		</div>
		<div class="stlms-customization-tab">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				<li class="nav-item" role="presentation">
					<button class="nav-link active" id="font-family-tab" data-tab="font-family" type="button" role="tab" aria-controls="font-family" aria-selected="true"><?php esc_html_e( 'Font Family', 'skilltriks-lms' ); ?></button>
				</li>
				<?php
			...
			<div class="tab-content stlms-tab-content">
				<div class="tab-pane active" id="font-family" role="tabpanel" aria-labelledby="font-family-tab" tabindex="0">
					<div class="tab-content-wrap">
						<div class="tab-title"><?php esc_html_e( 'Font Family', 'skilltriks-lms' ); ?></div>
						<div class="tab-content-row">
							<div class="font-prop-selector">
								<ul>
									<li>
										<div class="stlms-form-group">
											<label for="font-family-global"><?php esc_html_e( 'All Headings (Google Fonts)', 'skilltriks-lms' ); ?></label>
											<select class="form-select" data-style="fontFamily" name="font_family_global" data-target="font-family-global" id="font_family_global">
												<option <?php echo empty( $this->options[ $theme_name ]['typography']['global']['font_family'] ) ? 'selected' : ''; ?> value=""><?php esc_html_e( 'Default', 'skilltriks-lms' ); ?></option>
									...
									<li>
										<div class="stlms-form-group">
											<label for="font-family-body"><?php esc_html_e( 'All Body (Google Fonts)', 'skilltriks-lms' ); ?></label>
											<select class="form-select" data-style="fontFamily" name="font_family_body" data-target="font-family-body" id="font_family_body">
												<option <?php echo empty( $this->options[ $theme_name ]['typography']['body']['font_family'] ) ? 'selected' : ''; ?> value=""><?php esc_html_e( 'Default', 'skilltriks-lms' ); ?></option>
							...
							<div class="font-preview-wrap">
								<div class="font-preview-screen">
									<div class="title"><?php esc_html_e( 'Preview', 'skilltriks-lms' ); ?></div>
									<div class="preview-text" id="font-family-global">
										<?php esc_html_e( 'The quick brown fox jumps over the lazy dog', 'skilltriks-lms' ); ?>
									</div>
								</div>
								<div class="font-preview-screen">
									<div class="title"><?php esc_html_e( 'Preview', 'skilltriks-lms' ); ?></div>
										...
										<li>
											<div class="stlms-form-group">
												...
												<select class="form-select" data-style="<?php echo esc_attr( $data_style ); ?>" name="<?php echo esc_attr( $typography . '_' . $html_tag ); ?>" data-target="<?php echo esc_attr( 'preview_' . $html_tag ); ?>" id="<?php echo esc_attr( $typography . '_' . $html_tag ); ?>" <?php echo 0 !== $index ? 'disabled' : ''; ?>>
													<option <?php echo empty( $this->options[ $theme_name ]['typography'][ $html_tag ][ $typography ] ) ? 'selected' : ''; ?> value=""><?php esc_html_e( 'Default', 'skilltriks-lms' ); ?></option>
