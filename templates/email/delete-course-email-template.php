									...
									<table cellspacing="0" cellpadding="0" width="100%">
										...
										<tr>
											<td style="padding-bottom: 16px;">
												The course
												<a href="<?php echo esc_url( $args['course_link'] ); ?>" style="color: #0F5AA7; text-decoration: none;"><?php echo esc_html( $args['course_name'] ); ?></a>, previously assigned to you, has been removed by
												<?php echo esc_html( $args['from_user'] ); ?>.
											</td>
										</tr>
										<tr>
											<td style="padding-bottom: 16px;">
												You don’t need to take any further action for this course.
											</td>
										</tr>
										<tr>
