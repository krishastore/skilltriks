<?php
/**
 * Email template for assigned course due soon.
 *
 * @package ST\Lms
 *
									...
									<table cellspacing="0" cellpadding="0" width="100%">
										...
										<tr>
											<td style="padding-bottom: 16px;">
												Just a reminder that your assigned course
												<a href="<?php echo esc_url( $args['course_link'] ); ?>" style="color: #0F5AA7; text-decoration: none;">
													<?php echo esc_html( $args['course_name'] ); ?>
												</a>
												is due on <?php echo esc_html( wp_date( $date_format, strtotime( $args['due_date'] ) ) ); ?>
											</td>
										</tr>
										<tr>
											<td style="padding-bottom: 16px;">
												You still have time to complete it and unlock your achievement!
											</td>
										</tr>
										<tr>
											<td style="padding-bottom: 16px;">All the best</td>
										</tr>
										<tr>
