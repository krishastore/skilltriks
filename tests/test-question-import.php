 ...
 */
class QuestionImportTest extends WP_Ajax_UnitTestCase {

	/**
	 * Test question import.
	 */
	public function test_question_import() {
		...
		$attachment = $this->factory->attachment->create_upload_object( STLMS_ASSETS . '/csv/question.csv', $media->ID );
		...
		$question = new \ST\Lms\Import\QuestionImport();
